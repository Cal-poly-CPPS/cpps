...
const CoursesUploadPage = ({ prop1, prop2 }) => {
    const [selectedFFiles, setSelectedFiles] = useState([]);
    ...
    return(
        <DashboardLayout>
            <div className={COURSES_UPLOAD_PAGE_STYLES.backgroundBox}>
                <div className={COURSES_UPLOAD_PAGE_STYLES.className}>Senior Project</div>
                ...
                <div className={COURSES_UPLOAD_PAGE_STYLES.bottomHalf}>
                    <div className={COURSES_UPLOAD_PAGE_STYLES.infoSideBar}>
                        <button className={COURSES_UPLOAD_PAGE_STYLES.backButton}>Back</button>
                        <div className={COURSES_UPLOAD_PAGE_STYLES.belowButton}>What You Can Upload</div>
                    ...
                    <div className={COURSES_UPLOAD_PAGE_STYLES.interactiveCenter}>
                        ...
                        <button className={COURSES_UPLOAD_PAGE_STYLES.uploadButton} onClick={handleUpload}>Upload Your Content Here</button>
                        <div className={COURSES_UPLOAD_PAGE_STYLES.dropAndDrag}>Drag Here</div>
                        ...
                        <button className={COURSES_UPLOAD_PAGE_STYLES.submitButton}>Submit</button>
                    </div>
                </div>
            </div>
        </DashboardLayout>
